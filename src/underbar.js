...
(function() {
  ...
  // Return all elements of an array that pass a truth test.  Test is second parameter.
 
 _.filter = function(collection, test) {
    var results = [];
    _.each(collection, function(value, index, list) {
      if (test.call(context, value, index, list)) results.push(value);
    });
    return results;
  };
  ...
  // copying code in and modifying it
   ...
   _.reject = function(collection, test) {
     var filteredResults = _.filter(collection, function(collection){
       return !test.call(this, collection); }, this);
...
_.memoize = function (func) {
  ...
  return function() {
    ...
    else return (memo[arg] = func.apply(this, arg));
  }
};
